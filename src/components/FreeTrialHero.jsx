    ...
    >
      <div className="relative z-10 flex flex-col items-center">
        ...
        <p className="my-6 max-w-xl text-center text-base leading-relaxed md:text-lg md:leading-relaxed">
          What is virtual learning? Why is it important? What can you gain from
          it? Read this article where we'll explore this ground-breaking
          phenomenon in-depth and find out.
        </p>
        <motion.button
          style={{
            border,
